...
const CtaBanner = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-r from-olive to-olive-dark text-white">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-playfair font-medium mb-6">
          Let's Build Your Dream Space Together
        </h2>
        
        <p className="text-lg text-cream/90 max-w-2xl mx-auto mb-10">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Link 
            to="/contact" 
            className="btn-secondary bg-white hover:bg-cream text-olive"
          >
            Get Free Quote
          </Link>
